...
本システムでは、主な利用者として以下のような中小企業・小規模事業者を想定しています。

- Web広告・SEOに大きな予算を確保することが難しい
- 専任のWebマーケティング担当者がいない
- 自社の商品・サービスをWeb上で効率的に訴求したい
- 生成AIを活用したいが、プロンプト設計やSEO分析を個別に行うノウハウ・時間がない
- コンテンツ制作から広告リンク管理、掲載期限管理までを少人数で運用したい

### Example Persona

従業員5〜50名程度の中小企業を想定。

営業・広報担当者がWeb運用を兼務しており、
高額な広告運用代行やコンテンツ制作を継続的に利用することは難しい一方、
低コストで継続的なWeb集客を行いたい事業者。

利用者自身が複雑なAIプロンプトやSEOの専門知識を扱わなくても、
...
という流れで運用できるシステムを目指します。

## Product Vision

将来的には単なるAI記事生成ツールではなく、

**「広告・マーケティングに大きな予算を投じることが難しい事業者でも、
AIを活用して低コストかつ効率的にWeb集客を行えるプラットフォーム」**
...
- AI Writer
- SEO Analyzer
- Affiliate / Advertisement Recommendation
- 掲載期限管理
- コンテンツ改善支援

などを組み合わせ、AIが生成・分析・提案を行い、
最終的な判断と公開は人間が行う設計を基本方針とします。
